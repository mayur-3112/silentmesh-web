  ...
  return (
    ...
    >
      <motion.p
        ...
        className="mb-4 text-[10px] tracking-[0.35em] text-[#00c9a7]/70 md:mb-6 md:text-sm md:tracking-[0.45em]"
      >
      ...
      <motion.h1
        ...
        className="text-[3.2rem] font-black leading-[0.9] tracking-[-0.05em] text-white sm:text-[5rem] md:text-[7rem] lg:text-[10rem] md:tracking-[-0.07em]"
      >
        Controlled
      ...
      <motion.p
        ...
        className="mt-6 max-w-md text-base leading-relaxed text-white/45 md:mt-10 md:max-w-xl md:text-xl"
      >
